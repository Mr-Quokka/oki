...
class PackageGateway
{
	...
	{
		$req = $this->pdo->prepare('INSERT INTO version (package_id, major, minor, patch, file_size, publisher_id) values (:package_id, :major, :minor, :patch, :file_size, :publisher_id);');
		try {
